import { Repository, EntityTarget, DataSource, FindOptionsWhere, FindManyOptions, FindOneOptions } from 'typeorm';
 ...
 */
export abstract class BaseRepository<TEntity, TId = string | number> {
